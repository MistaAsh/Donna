...
const UserMessage = ({ message }) => {
  return (
    <div className="flex justify-end w-full relative mb-6">
      <div className="flex bg-slate-300 rounded-2xl p-5 max-w-2xl min-w-[50px] text-right overflow-hidden">
        <div className="flex flex-col text-white flex-grow">{message}</div>
      </div>
